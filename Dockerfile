...
RUN pip install -U pip numpy pandas scikit-learn scipy enum-compat matplotlib requests Jinja2 ipykernel ipython ipython-genutils ipywidgets MarkupSafe msgpack-python ordered-set keras tensorflow jupyter_dashboards
